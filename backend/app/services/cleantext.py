...
_DATE_PATTERN = r'''
    ...
    (?:
        ...
        [0-9０-９]{1,2}[ \u3000]?月[ \u3000]?[0-9０-９]{1,2}[ \u3000]?日 |
        [0-9０-９]{4}[ \u3000]?年[ \u3000]?[0-9０-９]{1,2}[ \u3000]?月 |
        [0-9０-９]{4}[/-／－][0-9０-９]{1,2} |
        [0-9０-９]{2}[ \u3000]?年[ \u3000]?[0-9０-９]{1,2}(?:[ \u3000]?月)
    )
'''
...
_FISCAL_PATTERN = r'''
    (?<![.,+\-△▲])
    (?:
        [0-9０-９]{4}/[0-9０-９]{1,2}期(?:\s*[1-4]Q)? |
        [0-9０-９]{2}/[0-9０-９]{1,2}期(?:\s*[1-4]Q)? |
        [0-9０-９]{4}[ \u3000]?年[ \u3000]?[0-9０-９]{1,2}[ \u3000]?月期 |
        [0-9０-９]{2}[ \u3000]?年[ \u3000]?[0-9０-９]{1,2}[ \u3000]?月期
    )
'''
