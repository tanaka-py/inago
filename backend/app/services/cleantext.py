...
_DATE_PATTERN = r'''
    (?<![.,+\-△▲])
    (?:
        (?:19[8-9]\d|20[0-3]\d|2040)[ \u3000]?年[ \u3000]?
            (?:1[0-2]|0?[1-9])[ \u3000]?月[ \u3000]?
            (?:0?[1-9]|[12][0-9]|3[01])[ \u3000]?日 |
        (?:19[8-9]\d|20[0-3]\d|2040)[/-]
            (?:1[0-2]|0?[1-9])[/-]
            (?:0?[1-9]|[12][0-9]|3[01]) |
        (?:1[0-2]|0?[1-9])[ \u3000]?月[ \u3000]?
            (?:0?[1-9]|[12][0-9]|3[01])[ \u3000]?日 |
...
_FISCAL_PATTERN = r'''
    (?<![.,+\-△▲])
    (?:
        (?:19[8-9]\d|20[0-3]\d|2040)/(?:1[0-2]|0?[1-9])期(?:\s*(?:[1-4]Q))? |
        (?:[0-9０-９]{2})/(?:1[0-2]|0?[1-9])期(?:\s*(?:[1-4]Q))? |
        (?:19[8-9]\d|20[0-3]\d|2040)[ \u3000]?年[ \u3000]?(?:1[0-2]|0?[1-9])[ \u3000]?月期 |
...
_PERIOD_PATTERN = r'''
    (?<![.,+\-△▲])
    (?:
        (?:19[8-9]\d|20[0-3]\d|2040)[ \u3000]?年[ \u3000]?(?:1[0-2]|0?[1-9])[ \u3000]?[-～〜][ \u3000]?(?:1[0-2]|0?[1-9])[ \u3000]?月 |
        (?:19[8-9]\d|20[0-3]\d|2040)[/／－][ \u3000]?(?:1[0-2]|0?[1-9])[ \u3000]?[-～〜][ \u3000]?(?:1[0-2]|0?[1-9]) |
        (?:1[0-2]|0?[1-9])[ \u3000]?[-～〜][ \u3000]?(?:1[0-2]|0?[1-9])[ \u3000]?月 |
        (?:19[8-9]\d|20[0-3]\d|2040)[ \u3000]?年[ \u3000]?(?:1[0-2]|0?[1-9])[ \u3000]?月[ \u3000]?[-～〜][ \u3000]?(?:1[0-2]|0?[1-9])[ \u3000]?月
    )
'''
